...
import BrandShoot1 from "@live/../public/brandshoot/Brand_1.jpg";
import BrandShoot2 from "@live/../public/brandshoot/Brand_2.jpg";

import OurProcess from "@live/components/brandshoot/OurProcess";
import AboutSection from "@live/components/brandshoot/AboutSection";
import GetStartedSection from "@live/components/brandshoot/GetStartedSection";
import MultiImageAnimation from "@live/components/brandshoot/MultiImageAnimation";
import DeliveryOptions from "@live/components/brandshoot/DeliveryOptions";
import FAQ from "@live/components/brandshoot/FAQ";
import CallToAction from "@live/components/brandshoot/CallToAction";
import MultiCard from "@live/components/brandshoot/MultiCard";
import { ChevronRight } from "lucide-react";

const Pricing = dynamic (() => import("@live/components/brandshoot/Pricing"),{
  ssr:true,
});
...
export default function BrandShoot() {
  return (
    <>
      <PageBanner slot="brandshoot-banner" />
