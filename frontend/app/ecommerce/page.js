...
import Ecommerce1 from "@live/../public/ecommerce/Ecom1.jpg";
import Ecommerce2 from "@live/../public/ecommerce/Ecom2.jpg";

//import LocationStylingTipsSec from "@live/components/ecommerce/LocationStylingTipsSec";
//import HighEndResolution from "@live/components/ecommerce/HighEndResolution";
//import MoodBoardSectionV2 from "@live/components/ecommerce/MoodBoardSectionV2";
import OurProcess from "@live/components/ecommerce/OurProcess";
import AboutSection from "@live/components/ecommerce/AboutSection";
import GetStartedSection from "@live/components/ecommerce/GetStartedSection";
import MultiImageAnimation from "@live/components/ecommerce/MultiImageAnimation";
import DeliveryOptions from "@live/components/ecommerce/DeliveryOptions";
import FAQ from "@live/components/ecommerce/FAQ";
import CallToAction from "@live/components/ecommerce/CallToAction";
import MultiCard from "@live/components/ecommerce/MultiCard";
import { ChevronRight } from "lucide-react";

const Pricing = dynamic (() => import("@live/components/ecommerce/Pricing"),{
  ssr:true,
});
...
export default function Ecommerce() {
  return (
    <>
      <PageBanner slot="ecommerce-banner" />
