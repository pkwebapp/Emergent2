        ...
        <div className="container mx-auto max-w-[1400px] px-6 md:px-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-6 gap-3">
            {editorialImages.map((src, i) => (
              <FadeIn key={src} delay={i * 0.03} className={`${i === 0 || i === 5 ? 'md:col-span-2 md:row-span-2' : 'md:col-span-2'} relative aspect-[4/5] rounded-3xl overflow-hidden bg-[#161514]`}>
      ...
      <section className="py-16 md:py-24 bg-[#161514] text-white" data-testid="editorial-pricing-section">
        <div className="container mx-auto max-w-[1200px] px-6 md:px-10">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            {pricing.map((plan) => (
              <FadeIn key={plan.name} className={`rounded-[1.75rem] p-6 border ${plan.featured ? 'bg-[#FF5B22] border-[#FF5B22] text-white' : 'bg-white/5 border-white/10'}`} data-testid={`editorial-pricing-${plan.name.toLowerCase().replaceAll(' ', '-')}`}>
